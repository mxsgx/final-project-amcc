<section class="w-full px-8 text-gray-700 bg-white">
    <div class="container flex flex-col flex-wrap items-center justify-between py-5 px-2 mx-auto md:flex-row max-w-7xl">
        <div class="relative flex flex-col md:flex-row">
            <a href="{{ route('instructor.root') }}"
               class="flex items-center mb-5 font-medium text-rose-500 lg:w-auto lg:items-center lg:justify-center md:mb-0">
                <span class="mx-auto text-xl font-black leading-none text-rose-500 select-none">ABM Instructor</span>
            </a>
            <nav
                ...
                <a href="{{ route('instructor.courses.index') }}"
                   class="font-medium leading-6 @if(request()->routeIs('instructor.courses.lectures.edit', 'instructor.courses.lectures.create', 'instructor.courses.lectures.index', 'instructor.courses.index', 'instructor.courses.create', 'instructor.courses.edit')) text-rose-500 @else text-gray-600 @endif hover:text-rose-500">Courses</a>
            </nav>
        </div>
